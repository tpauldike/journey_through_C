...
It was interesting to note that both executable files produced exactly the same result, showing that our function can work well in the same file but we can separate them in order not to have our file too crowded and to make the code look easier to understand.
